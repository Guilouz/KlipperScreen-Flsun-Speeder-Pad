...
class Panel(ScreenPanel):
    ...
    def __init__(self, screen, title):
        ...
        if self._screen.vertical_mode:
            ...
            #grid.attach(self.buttons['unload'], 2, 2, 1, 1) # Changes
            #grid.attach(self.buttons['retract'], 3, 2, 1, 1) # Changes
            grid.attach(self.buttons['retract'], 0, 2, 1, 1) # Changes
            grid.attach(self.buttons['unload'], 1, 2, 1, 1) # Changes
            grid.attach(self.buttons['load'], 2, 2, 1, 1) # Changes
            grid.attach(self.buttons['extrude'], 3, 2, 1, 1) # Changes

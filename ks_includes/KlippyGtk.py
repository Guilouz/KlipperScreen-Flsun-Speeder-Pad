...
class KlippyGtk:
    ...
    # Changes
    def ScrolledWindow(self, steppers=True): # Changes
        ...
        if self.screen._config.get_main_config().getboolean("show_scroll_steppers", fallback=False) and steppers: # Changes
            scroll.get_vscrollbar().get_style_context().add_class("with-steppers") # Changes
        return scroll
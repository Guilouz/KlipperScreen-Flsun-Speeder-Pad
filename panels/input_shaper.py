...
class Panel(ScreenPanel):
    def __init__(self, screen, title):
        ...
        #auto_calibration_label.set_markup('<big><b>Auto Calibration</b></big>') # Changes
        ...
        #manual_calibration_label.set_markup('<big><b>Manual Calibration</b></big>') # Changes
        ...
        #disclaimer.set_markup('<small>NOTE: Edit your printer.cfg to save manual calibration changes.</small>') # Changes

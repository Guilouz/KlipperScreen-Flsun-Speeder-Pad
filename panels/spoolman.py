...
class Panel(ScreenPanel):
    ...
    def __init__(self, screen, title):
        ...
        sort_btn_id = self._gtk.Button("so_id", _("ID"), "color4", self.bts, Gtk.PositionType.RIGHT, 1)
        sort_btn_id.connect("clicked", self.change_sort, "id")
        sort_btn_id.get_style_context().add_class("buttons_slim")

        sort_btn_used = self._gtk.Button("so_last_used", _("Last Used"), "color3", self.bts, Gtk.PositionType.RIGHT, 1)
